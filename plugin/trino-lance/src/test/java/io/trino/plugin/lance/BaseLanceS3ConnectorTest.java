...
/**
 * Abstract base class for S3/LocalStack connector tests.
 * Manages the LocalStack container lifecycle and S3 bucket setup.
 */
public abstract class BaseLanceS3ConnectorTest
        extends BaseLanceConnectorTest
{
    private static final Logger log = Logger.get(BaseLanceS3ConnectorTest.class);

    protected static final String BUCKET_NAME = "lance-test-bucket";
