...
/**
 * Smoke test for directory namespace with parent prefix (3+ level access).
 * This mode has full schema support with parent namespace prefix.
 */
public class TestLanceDirectoryWithParentConnectorSmokeTest
        extends BaseLanceConnectorSmokeTest
{
    @Override
    protected LanceNamespaceTestConfig getNamespaceTestConfig()
    {
        return LanceNamespaceTestConfig.DIRECTORY_WITH_PARENT;
    }
