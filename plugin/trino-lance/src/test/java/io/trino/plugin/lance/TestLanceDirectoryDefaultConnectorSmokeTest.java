...
/**
 * Smoke test for directory namespace in default mode (2nd level access).
 * This mode has full schema support with direct schema-to-namespace mapping.
 */
public class TestLanceDirectoryDefaultConnectorSmokeTest
        extends BaseLanceConnectorSmokeTest
{
    @Override
    protected LanceNamespaceTestConfig getNamespaceTestConfig()
    {
        return LanceNamespaceTestConfig.DIRECTORY_DEFAULT;
    }
