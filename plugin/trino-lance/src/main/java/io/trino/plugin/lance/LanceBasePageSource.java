        ...
        implements ConnectorPageSource
{
    ...
    public void close()
    {
        // Close the child allocator even if the scanner fails to close, so the resources allocated
        // by this page source are always released (scanner close() can throw).
        try (bufferAllocator) {
